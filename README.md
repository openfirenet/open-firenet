...
- Controls **MultiAir 1 & 2** forced-air convection fans on supported stove models (DOMO, PARO, PRIMO, ROCO MULTIAIR, SUMO MULTIAIR, DOMO BACK)
...
| **`29`** | **RIKA PRIMO** | MultiAir 1 & 2 (optional on this model) |
